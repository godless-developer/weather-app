export const CircleM = () => {
  return (
    <>
      <div className="absolute flex justify-center items-center w-[1740px] h-[1740px] border-[1px] border-[#000]/10 rounded-full overflow-hidden">
        <div className="absolute flex justify-center items-center w-[1340px] h-[1340px] border-[1px] border-[#000]/10 rounded-full">
          <div className="absolute flex justify-center items-center w-[940px] h-[940px] border-[1px] border-[#000]/10 rounded-full">
            <div className="flex justify-center items-center w-[540px] h-[540px] border-[1px] border-[#000]/10 rounded-full">
              <div className="flex justify-center items-center w-[340px] h-[340px] border-[1px] border-[#000]/10 rounded-full">
                <div className="flex  gap-[16px] bg-[#F3F4F6] hover:bg-[#e4e5e6] rounded-full w-[140px] h-[140px] justify-center items-center border-[1px] border-[#000]/10 cursor-pointer">
                  <a
